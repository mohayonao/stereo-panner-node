...
function StereoPannerNode(e,n){n=n||{};var t=e.createChannelSplitter(2),a=e.createWaveShaper(),r=e.createWaveShaper(),o=e.createGain(),c=e.createWaveShaper(),i=e.createWaveShaper(),l=e.createGain(),u=e.createGain(),p=e.createChannelMerger(2),d="number"==typeof n.pan?n.pan:0;return t.channelCount=2,t.channelCountMode="explicit",t.channelInterpretation="speakers",t.connect(l,0),t.connect(u,1),t.connect(a,1),t.connect(r,1),a.channelCount=1,a.channelCountMode="explicit",a.channelInterpretation="discrete",a.curve=curveDC,a.connect(o),r.channelCount=1,r.channelCountMode="explicit",r.channelInterpretation="discrete",r.curve=curveFix,r.connect(o.gain),o.channelCount=1,o.ChannelMergerNode="explicit",o.channelInterpretation="discrete",o.gain.value=d,o.connect(c),o.connect(i),c.channelCount=1,c.channelCountMode="explicit",c.channelInterpretation="discrete",c.curve=curveL,c.connect(l.gain),i.channelCount=1,i.channelCountMode="explicit",i.channelInterpretation="discrete",i.curve=curveR,i.connect(u.gain),l.channelCount=1,l.channelCountMode="explicit",l.channelInterpretation="discrete",l.gain.value=0,l.connect(p,0,0),u.channelCount=1,u.channelCountMode="explicit",u.channelInterpretation="discrete",u.gain.value=0,u.connect(p,0,1),p.channelCount=1,p.channelCountMode="explicit",p.channelInterpretation="discrete",Object.defineProperties(t,{pan:{value:o.gain,enumerable:!0,writable:!1,configurable:!0},connect:{value:AudioNode.prototype.connect.bind(p),enumerable:!1,writable:!1,configurable:!0},disconnect:{value:AudioNode.prototype.disconnect.bind(p),enumerable:!1,writable:!1,configurable:!0}}),t}for(var BaseAudioContext=require("base-audio-context"),WS_CURVE_SIZE=4096,curveL=new Float32Array(WS_CURVE_SIZE),curveR=new Float32Array(WS_CURVE_SIZE),curveFix=new Float32Array([0,0]),curveDC=new Float32Array([1,1]),i=0;i<WS_CURVE_SIZE;i++)curveL[i]=Math.cos(i/WS_CURVE_SIZE*Math.PI*.5),curveR[i]=Math.sin(i/WS_CURVE_SIZE*Math.PI*.5);StereoPannerNode.polyfill=function(){BaseAudioContext&&!BaseAudioContext.prototype.hasOwnProperty("createStereoPanner")&&StereoPannerNode.install()},StereoPannerNode.install=function(){Object.defineProperty(BaseAudioContext.prototype,"createStereoPanner",{value:function(){return new StereoPannerNode(this)},enumerable:!1,writable:!1,configurable:!0})},"function"==typeof Symbol&&"symbol"==typeof Symbol.hasInstance&&Object.defineProperty(StereoPannerNode,Symbol.hasInstance,{value:function(e){return e instanceof AudioNode&&e.pan instanceof AudioParam}}),module.exports=StereoPannerNode;
