 ...
 *  +--------------------------------+
 */
function StereoPannerNodeImpl(audioContext) {
...
StereoPannerNodeImpl.prototype.connect = function(destination) {
...
StereoPannerNodeImpl.prototype.disconnect = function() {
  var audioContext = this.audioContext;
...
module.exports = StereoPannerNodeImpl;
